# <img src="assets/icons/star.svg" width="28" height="28"/> AnimeDekho Provider - Cosmix Extension

A **Cosmix** extension for streaming anime, cartoons, and movies from **AnimeDekho**, **HindiSubAnime**, and **OnePace** with Hindi dub and subtitle support.
...
1. Download the latest `.csx` or extension file from [Releases](https://github.com/senkuboy0-cyber/Anime-Dekho/releases)
2. Open **Cosmix** app
...
- <img src="assets/icons/check.svg" width="16" height="16"/> **Cosmix** app installed on your Android device
...
- Cosmix by [cosmix-app](https://github.com/cosmix-app)
...
[![Cosmix](https://img.shields.io/badge/Cosmix-Extension-blue?style=for-the-badge)](https://github.com/cosmix-app/cosmix)
